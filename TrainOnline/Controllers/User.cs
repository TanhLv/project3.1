...
{
    public class User : BaseeController
    {
        public User(IHttpContextAccessor contextAccessor, UserManager<CustomUser> userName, RoleManager<IdentityRole> roleManager) : base(contextAccessor, userName, roleManager)
        {
        }
